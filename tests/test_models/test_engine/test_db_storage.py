...
class TestFileStorage(unittest.TestCase):
    ...
    def test_pep8_conformance_test_FileStorage(self):
        """
        test_file_storage.py file conform to PEP8
        """
        pep8style = pep8.StyleGuide(quiet=True)
    ...
    def test_save(self):
        """save functionality for FileStorage"""
    ...
    def test_reload(self):
        """reload functionality for FileStorage"""
        storage.reload()
        obj_d = storage.all()
    ...
    def test_delete_basic(self):
        """delete basic functionality for FileStorage"""
        obj_d = storage.all()
    ...
    def test_new_basic(self):
        """new basic functionality for FileStorage"""
        obj = BaseModel()
        storage.new(obj)
        obj_d = storage.all()
    ...
    def test_new_badinput(self):
        """new bad input functionality for FileStorage"""
        try:
